...
class Service {
  ...
  public function post_type() {
    ...
    $args    = array(
        ...
        'description'         => __( 'Site service.', \SourceFramework\TEXTDOMAIN ),
        'labels'              => $labels,
  ...
  public function category() {
    $labels  = array(
        ...
        'all_items'                  => __( 'All Service Categories', \SourceFramework\TEXTDOMAIN ),
  ...
  public function tag() {
    $labels  = array(
        ...
        'all_items'                  => __( 'All Service Tags', \SourceFramework\TEXTDOMAIN ),
