...
class Place {
  ...
  public function post_type() {
    ...
    $args    = array(
        ...
        'description'         => __( 'Site place.', \SourceFramework\TEXTDOMAIN ),
        'labels'              => $labels,
  ...
  public function category() {
    $labels  = array(
        ...
        'all_items'                  => __( 'All Place Categories', \SourceFramework\TEXTDOMAIN ),
  ...
  public function tag() {
    $labels  = array(
        ...
        'all_items'                  => __( 'All Place Tags', \SourceFramework\TEXTDOMAIN ),
