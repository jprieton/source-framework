...
class Assets extends Singleton {
  ...
  private function register_admin_styles() {
    $styles = [
        'source-framework-admin' => [
            'local'    => plugins_url( 'assets/css/admin.min.css', SF_FILENAME ),
            'ver'      => SF_VERSION,
            'autoload' => true
        ],
    ];
  ...
  private function register_styles() {
    ...
    $styles = [
        'source-framework'            => [
            'local'    => plugins_url( 'assets/css/public.min.css', SF_FILENAME ),
            'ver'      => SF_VERSION,
            'autoload' => true,
        ],
    ];
  ...
  private function register_admin_scripts() {
    $scripts = array(
        'source-framework-admin' => array(
            'local'     => plugins_url( 'assets/js/admin.min.js', SF_FILENAME ),
            'deps'      => array( 'jquery' ),
            'ver'       => SF_VERSION,
            'in_footer' => true,
            'autoload'  => true,
  ...
  private function register_scripts() {
    ...
    $scripts = [
        'source-framework' => [
            'local'     => plugins_url( 'assets/js/public.min.js', SF_FILENAME ),
            'deps'      => [ 'jquery' ],
            'ver'       => SF_VERSION,
            'in_footer' => true,
            'autoload'  => true,
